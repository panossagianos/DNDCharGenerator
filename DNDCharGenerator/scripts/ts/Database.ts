...
namespace DNDCharacterGenerator {
    ...
    export namespace Database {
        import gen = DNDCharacterGenerator.Library;
        /**
        ...
        export namespace Alignment {
            export let lawfulGood = new gen.Alignment("Lawful Good"
                ...
                , gen.alignmentType.Good, gen.alignmentLoyalty.Lawful);
            export let lawfulNeutral = new gen.Alignment("Lawful Neutral"
                ...
                , gen.alignmentType.Neutral, gen.alignmentLoyalty.Lawful);
            export let lawfulEvil = new gen.Alignment("Lawful Evil"
                ...
                , gen.alignmentType.Evil, gen.alignmentLoyalty.Lawful);

            export let neutralGood = new gen.Alignment("Neutral Good"
                ...
                , gen.alignmentType.Good, gen.alignmentLoyalty.Neutral);
            export let trueNeutral = new gen.Alignment("True Neutral",
                ...
                , gen.alignmentType.Neutral, gen.alignmentLoyalty.Neutral);
            export let neutralEvil = new gen.Alignment("Neutral Evil"
                ...
                , gen.alignmentType.Evil, gen.alignmentLoyalty.Neutral);

            export let chaoticGood = new gen.Alignment("Chaotic Good"
                , "Chaotic good (CG) creatures act as their conscience directs, with little regard for what others expect."
                + " Copper dragons, many elves, and unicorns are chaotic good."
                , gen.alignmentType.Good, gen.alignmentLoyalty.Chaotic);
            export let chaoticNeutral = new gen.Alignment("Chaotic Neutral"
                ...
                , gen.alignmentType.Neutral, gen.alignmentLoyalty.Chaotic);
            export let chaoticEvil = new gen.Alignment("Chaotic Evil"
        ...
        export namespace Ability {
            ...
            /** Measures agility.*/
            export let dexterity = new gen.Ability("Dexterity", "Dexterity measures agility, reflexes, and balance.", "Dex", undefined);
            /** Measures endurance.*/
            export let constitution = new gen.Ability("Constitution", "Measures endurance.", "Con", undefined);
            /** Measures reasoning and memory.*/
            export let intelligence = new gen.Ability("Intelligence", "Measures reasoning and memory.", "Int", undefined);
            /** Measures perception and insight.*/
            export let wisdom = new gen.Ability("Wisdom", "Measures perception and insight.", "Wis", undefined);
            /** Measures force of personality.*/
            export let charisma = new gen.Ability("Charisma", "Measures force of personality.", "Cha", undefined);
        }
        /**
        ...
        export namespace Skill {
             ...
             */
            export let acrobatics = new gen.Skill("Acrobatics"
             ...
             */
            export let sleightOfHand = new gen.Skill("Sleight of Hand"
             ...
             */
            export let stealth = new gen.Skill("Stealth"
             ...
             */
            export let arcana = new gen.Skill("Arcana"
             ...
             */
            export let history = new gen.Skill("History"
             ...
             */
            export let investigation = new gen.Skill("Investigation"
             ...
             */
            export let nature = new gen.Skill("Nature"
             ...
             */
            export let religion = new gen.Skill("Religion"
             ...
             */
            export let animalHandling = new gen.Skill("Animal Handling"
             ...
             */
            export let insight = new gen.Skill("Insight"
             ...
             */
            export let survival = new gen.Skill("Survival"
             ...
             */
            export let deception = new gen.Skill("Deception"
             ...
             */
            export let intimidation = new gen.Skill("Intimidation"
             ...
             */
            export let performance = new gen.Skill("Performance"
             ...
             */
            export let persuasion = new gen.Skill("Persuasion"
        ...
        export namespace Trait {
             ...
             */
            export let darkVision = new gen.Trait("Darkvision"
